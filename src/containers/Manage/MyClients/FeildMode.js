...
//ACTIONS
import { deleteUserFieldMode, fetchMyClients, editUserFieldMode, postUserFieldMode, hideServerErrorModal, hideServerSucessModal } from "../../../actions/action_authentication"
...
class FeildMode extends Component {
  ...
  componentDidMount() {
    this.props.fetchMyClients({}, this.props.token);
  }
...
const mapStateToProps = state => {
  return {
    ...
    payloadFetchData: state.serverData.fetchClientsList,
...
export default connect(
  mapStateToProps,
  { deleteUserFieldMode, fetchMyClients, editUserFieldMode, postUserFieldMode, hideServerErrorModal, hideServerSucessModal }
)(HOC(FeildMode));
